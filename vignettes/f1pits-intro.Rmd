...
This package can be considered complementary to the `f1dataR` package, which provides Formula 1 race data. You can download the package in [GitHub](https://github.com/Jordan-Soria/f1pits).
...
Finally, if you want a fun text for your plot, run the 'pitart()' function in the title_text argument or, for example, title_text = paste0(aaa,"&nbsp;&nbsp;&nbsp;&nbsp;Pit Stop data").
